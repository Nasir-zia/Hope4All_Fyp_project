...
export const CONFIG = {
  API_BASE_URL: process.env.EXPO_PUBLIC_API_URL || 'https://hope4allfypproject-production.up.railway.app/api',
  SOCKET_URL: process.env.EXPO_PUBLIC_SOCKET_URL || 'https://hope4allfypproject-production.up.railway.app',
